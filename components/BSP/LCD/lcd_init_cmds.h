...
/*
 * 1.8 寸 360x360 ST77916 QSPI 初始化。
 * 来源：Arduino_GFX st77916_180_init_operations（默认就是 1.8 寸这套）。
 * 与 VoCat/1.5 寸的 0xF0=0x28 表不是同一块玻璃；T180BV-C20-02 是 1.8 寸。
 * 只抄寄存器表，不引入 Arduino 库。命令仍由官方 esp_lcd_st77916 用 opcode 0x02 发出。
 */
